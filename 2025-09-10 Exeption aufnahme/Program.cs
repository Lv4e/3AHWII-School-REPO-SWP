...
class Program
{
    static void Main(string[] args)
    {
        try
        {
            if (args.Length < 2)
            {
                Console.WriteLine("Fehler: Bitte geben Sie zwei Brüche als Argumente an.");
                return;
            }
        ...
        {
            Console.WriteLine("Fehler: Ungültiges Eingabeformat. Bitte geben Sie die Brüche im Format 'Ganzzahl Zähler/Nenner' oder 'Zähler/Nenner' ein.");
        }
    ...
    static Tuple<int, int> ToImproperFraction(string input)
    {
        ...
        {
            throw; // Fehler wird im Main behandelt
        }
    }
